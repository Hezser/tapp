...
//
//class FriendsController: UIViewController, UISearchResultsUpdating, UITableViewDelegate, UITableViewDataSource {
//    // CRASH: FriendsNames cannot be nil (not having friends on facebook is a problem)
//    
